...
Original file is located at
    https://colab.research.google.com/drive/1IPedSLixZ79XHJDAT2duvAUMvGh5HEJo
"""
...
# Get encoding of data file
with open("C:/Users/Karthik Vaddi/Downloads/genre_data_clean1 (1).csv", 'rb') as file:
...
# Floydhub version
data = pd.read_csv("C:/Users/Karthik Vaddi/Downloads/genre_data_clean1 (1).csv", encoding="utf-8")
print(data.head())
...
text_train, text_test, genre_train, genre_test = train_test_split(normed_text, genre, test_size=0.2)
...
df2 = pd.DataFrame(genre_train)
df2 = df2.rename(columns={0: 'genre'})
df_train = pd.concat([df1, df2], axis=1)

df_train.head()

df3 = pd.DataFrame(text_test)
df3 = df3.rename(columns={0: 'text'})

df4 = pd.DataFrame(genre_test)
...
gram1_train = create_n_grams(text_train, 1, 37449,  350)
gram2_train = create_n_grams(text_train, 2, 312256, 350)
gram3_train = create_n_grams(text_train, 3, 590427, 350)
gram4_train = create_n_grams(text_train, 4, 665940, 350)

gram1_test = create_n_grams(text_test, 1, 37449, 350)
gram2_test = create_n_grams(text_test, 2, 312256, 350)
gram3_test = create_n_grams(text_test, 3, 590427, 350)
gram4_test= create_n_grams(text_train, 4, 665940, 350)
...
gram4_model = define_model(350, 7, max_3gram + 1, 300)

# Train 4-gram CNN

gram4_model.fit([gram4_train, gram4_train, gram4_train], genre_train_hot, epochs=7, batch_size=32,
              verbose=1, validation_split=0.2)
...
# Fit model
model1 = define_model(350, 7, max_3gram + 1, 100)
